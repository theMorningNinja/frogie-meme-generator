...
(function (i, n) {
  ...
  o.updateColors = function () {
    ...
    if (this.getCustomLength()) {
      var s = 0;
      this.options.customColors.forEach(
        function (t) {
          var e = s % o;
  ...
  o.addSwatch = function (t, e, i) {
    this.swatches[e + ',' + i] = t;
    this.colorGrid[t.color.toUpperCase()] = { x: e, y: i };
  };
  var u = {
    hsl: function (t, e, i) {
      e = Math.round(e * 100);
  ...
  o.updateSizes = function () {
    ...
    this.canvasOffset = { x: this.canvas.offsetLeft, y: this.canvas.offsetTop };
    var s, r;
    if (o && !n) {
      s = Math.min(o, t);
      r = Math.ceil(o / t);
  ...
  o.updateOffset = function () {
    ...
    this.offset = { x: t.left + e.pageXOffset, y: t.top + e.pageYOffset };
  };
